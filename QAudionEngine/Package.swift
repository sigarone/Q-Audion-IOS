...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/sigarone/qaudion-crypto-core/releases/download/v0.1.0/QaudionCryptoCore.xcframework.zip",
            checksum: "9e630c76fee97398c6206a9c433f8db23752ed1727a829b8b3494bdc18bc697c"
        ),
        .target(
            name: "CLiboqs",
