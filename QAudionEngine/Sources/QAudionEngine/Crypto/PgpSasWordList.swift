...
/// PGP-style word list for Short Authentication String display.
///
/// 256-entry list of phonetically distinct two- and three-syllable
/// English words, byte-for-byte identical to Android's
/// `feature/feature-call/.../sas/PgpSasWordList.kt`.
///
/// This is the "even-index" column of Patrick Juola's PGP Biometric
/// Word List (RFC 1751-inspired, used by Signal / Silent Phone / ZRTP).
///
/// Kept in source rather than loaded from an asset so the SAS
/// derivation is deterministic and audit-reproducible.
public enum PgpSasWordList {
